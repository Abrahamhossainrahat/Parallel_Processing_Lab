...
int main(int argc, char **argv) {
    ...
    // mpirun -np 4 ./p phonebook1.txt AISHWARYA   ---> here "./p phonebook1.txt AISHWARYA" is the argv
    string search_term = argv[argc - 1];
    double master_search_start, master_search_end;
    ...
    if (rank == 0) {
        ...
        // -------- Master own search time --------
        master_search_start = MPI_Wtime();
        ...
        printf("Process 0 (master) search time: %f seconds\n", master_search_end - master_search_start);
